...
-- Create date: <Create Date,,11 Aug 2018>
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetC5Data
...
BEGIN
   ...
   Select left(c.[Account_Number_LongCode],2) as code, b.[Schedule_Code] as C5
	...
	where b.[Schedule_Sheet] = '5'
	GROUP BY b.[Schedule_Code],left(c.[Account_Number_LongCode],2)
