...
-- Create date: <Create Date,,12 August>
-- Description:	<Description,,Get SC13E Data>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetSC13EData 
...
BEGIN
    ...
    -- Insert statements for procedure here
	 Select  b.[Schedule_Code] as SC13e
