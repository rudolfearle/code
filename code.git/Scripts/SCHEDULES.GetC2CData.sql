...
-- =============================================
CREATE PROCEDURE SCHEDULES.GetC2CData
...
BEGIN
	...
	Select left(c.[Account_Number_LongCode],2) as t, b.[Schedule_Code] as C2C,a.[Ledger_Group_Description] as Ledger_type
