...
-- Description:	<Description,,Get C4 Data>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetC4Data
...
BEGIN
   ...
   Select left(c.[Account_Number_LongCode],2) as t, b.[Schedule_Code] as C4,a.[Ledger_Group_Description] as Ledger_type
	...
	GROUP BY a.[Ledger_Group_Description],b.[Schedule_Code],left(c.[Account_Number_LongCode],2)
