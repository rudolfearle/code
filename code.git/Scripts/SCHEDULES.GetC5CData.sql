...
-- Description:	<Description,,C5C sheet>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetC5CData 
...
Select left(c.[Account_Number_LongCode],2) as t, b.[Schedule_Code] as C5C
