...
-- Description:	<Description,, get data C6 Data>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetC6Data 
...
BEGIN
	...
	INNER JOIN [mSCOA_Vault].[dbo].[Cons_Vault] b on b.[Recommended_Invoice_Guid] = a.mSCOA_Item_Guid 
	where b.[Schedule_Sheet] = '6'
