...
-- Create date: <Create Date,,12 Agust 2018>
-- Description:	<Description,,Get SC8 Data>
-- =============================================
CREATE PROCEDURE SCHEDULES.GetSC8Data 
...
Select left(c.[Account_Number_LongCode],8) as groupStaff, c.[Schedule_Code] as SC8
	...
	INNER JOIN [mSCOA_Vault].[dbo].[Cons_Vault] p on p.[Project_Guid] = a.mSCOA_Project_Guid and left(p.[Account_Number_LongCode],2) = 'PO'
	where c.[Schedule_Sheet] = 'SA1'
	GROUP BY c.[Schedule_Code],left(c.[Account_Number_LongCode],8)
